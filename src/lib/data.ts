...
/** Returns the correct "X de Banco" label for a property type */
export function getBankOwnedLabel(propertyType?: string | null): string {
  const labels: Record<string, string> = {
    piso: "Piso de Banco",
    casa: "Casa de Banco",
    local: "Local de Banco",
    garaje: "Garaje de Banco",
    solar: "Solar de Banco",
    edificio: "Edificio de Banco",
    oficina: "Oficina de Banco",
    industrial: "Nave de Banco",
    trastero: "Trastero de Banco",
  };
  return (propertyType ? labels[propertyType.toLowerCase()] : null) ?? "Propiedad de Banco";
}
