    ...
    >
      ...
      >
        <div className="relative aspect-[4/3] overflow-hidden">
          ...
          {/* Top Right - Current Status (Venta / Alquiler / Pendiente / Reservado / Vendido / Alquilado) */}
          {!!listing.status && (
            <Badge
              variant="outline"
          ...
          {/* Vendido / Alquilado overlay — bold rose pill */}
          {(listing.status === "Vendido" || listing.status === "Alquilado") && (
            <div className="absolute inset-0 z-20 flex items-center justify-center">
              <span className="whitespace-nowrap rounded-full bg-rose-600/95 px-6 py-2 text-sm font-semibold uppercase tracking-[0.25em] text-white shadow-xl ring-1 ring-rose-500/40 backdrop-blur-md">
                {listing.status}
              </span>
            </div>
          )}
